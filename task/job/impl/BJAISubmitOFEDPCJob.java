 ...
 */
@Service
public class BJAISubmitOFEDPCJob extends SuperJob implements SubmitJob {
	
	public BJAISubmitOFEDPCJob(){
		//设置为报送群组
	...
	public boolean submit(String startDate, String endDate) throws CISException,Exception {
		//获取平台
		System.out.println("=================北京意外险报送批处理-个险承保信息同步上传开始=================");
		try{
			...
			System.out.println("=================北京意外险报送批处理-个险承保信息同步上传结束 =================");	
		}
	}
}
