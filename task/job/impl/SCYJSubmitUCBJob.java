 ...
 */
@Service
public class SCYJSubmitUCBJob extends SuperJob implements SubmitJob{
	...
	public boolean submit(String startDate, String endDate)
		...
		//TODO 报送开始
		System.out.println("================= 四川意健险数据报送,UCB保单T+1上传批处理开始 =================");
		try{
			String bussType = "UCB";
			String bussNo = "";
			...
			System.out.println("================= 四川意健险数据报送,UCB保单T+1上传批处理结束 =================");	
		}
	}
