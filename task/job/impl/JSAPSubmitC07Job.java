 ...
 */ 
@Service
public class JSAPSubmitC07Job extends SuperJob implements SubmitJob {
	
	public JSAPSubmitC07Job(){
		//设置为报送群组
	...
	public boolean submit(String startDate, String endDate) throws CISException,Exception {
		//获取平台
		System.out.println("=================江苏中介报送批处理-手续费结算确认上传开始=================");
		try{
			...
			System.out.println("=================江苏中介报送批处理-手续费结算确认上传结束 =================");	
		}
	}
}
