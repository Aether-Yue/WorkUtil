...
/**
 * 山东预警平台：C01-保单登记(承保/保全)
 * @author Darker.Wang
 * @date 2017-10-17 上午9:41:26
 * @company SINOSOFT
 */
public class SDPTSubmitC01Job extends SuperJob implements SubmitJob{
	...
	public boolean submit(String startDate, String endDate)
		...
		//TODO 报送开始
		System.out.println("================= 山东预警数据报送,C01-保单登记(承保/保全)批处理开始 =================");
		try{
			String bussType = "C01";
			String bussNo = "";
			...
			System.out.println("================= 山东预警数据报送，C01-保单登记(承保/保全)批处理结束 =================");	
		}
	}
