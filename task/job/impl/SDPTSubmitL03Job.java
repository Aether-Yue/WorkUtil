 ...
 * 山东预警平台：L03-理赔风险查询
 * @author Darker.Wang
 * @date 2017-10-17 上午9:43:27
 * @company SINOSOFT
 */
public class SDPTSubmitL03Job extends SuperJob implements SubmitJob{
	...
	public boolean submit(String startDate, String endDate)
		...
		//TODO 报送开始
		System.out.println("================= 山东预警数据报送,L03-理赔风险查询批处理开始 =================");
		try{
			String bussType = "L03";
			String bussNo = "";
			...
			System.out.println("================= 山东预警数据报送，L03-理赔风险查询批处理结束 =================");	
		}
	}
