 ...
 * 山东预警平台：C03-承保风险查询
 * @author Darker.Wang
 * @date 2017-10-17 上午9:40:47
 * @company SINOSOFT
 */
public class SDPTSubmitC03Job extends SuperJob implements SubmitJob{
	...
	public boolean submit(String startDate, String endDate)
		...
		//TODO 报送开始
		System.out.println("================= 山东预警数据报送,C03-承保风险查询批处理开始 =================");
		try{
			String bussType = "C03";
			String bussNo = "";
			...
			System.out.println("================= 山东预警数据报送，C03-承保风险查询批处理结束 =================");	
		}
	}
