 ...
 * 山东预警平台：L01-立案登记(理赔)
 * @author Darker.Wang
 * @date 2017-10-17 上午9:41:59
 * @company SINOSOFT
 */
public class SDPTSubmitL01Job extends SuperJob implements SubmitJob{
	...
	public boolean submit(String startDate, String endDate)
		...
		//TODO 报送开始
		System.out.println("================= 山东预警数据报送,L01-立案登记(理赔)批处理开始 =================");
		try{
			String bussType = "L01";
			String bussNo = "";
			...
			System.out.println("================= 山东预警数据报送，L01-立案登记(理赔)批处理结束 =================");	
		}
	}
