 ...
 */
@Service
public class SHIASubmitP03Job extends SuperJob implements SubmitJob {
	
	public SHIASubmitP03Job(){
		//设置为报送群组
	...
	public boolean submit(String startDate, String endDate) throws Exception {
		...
		try{
			...
			String errorMsg = "上海人身险业务类型：P01 执行失败！<br>";
