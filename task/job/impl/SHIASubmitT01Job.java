 ...
 */
@Service
public class SHIASubmitT01Job extends SuperJob implements SubmitJob {
	
	public SHIASubmitT01Job(){
		//设置为报送群组
	...
	public boolean submit(String startDate, String endDate) throws Exception {
		...
		try{
			...
			String errorMsg = "上海人身险业务类型：T01  执行失败！<br>";
